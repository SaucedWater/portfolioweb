      ...
      <header className="bg-gray-950 text-gray-200 py-6 sticky top-0 z-50 shadow-xl transition-all">
        <div className="container mx-auto flex flex-col items-center">
          <nav className="flex space-x-6">
            <a href="#about" className="hover:text-cyan-500 transition-all duration-300">
              About
            </a>
            <a href="#projects" className="hover:text-cyan-500 transition-all duration-300">
              Projects
            </a>
            <a href="#skills" className="hover:text-cyan-500 transition-all duration-300">
              Skills
            </a>
            <a href="#contact" className="hover:text-cyan-500 transition-all duration-300">
              Contact
            </a>
            <a href="#miscellaneous" className="hover:text-cyan-500 transition-all duration-300">
              Miscellaneous
            </a>
          </nav>
        </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-xl hover:shadow-2xl transition-all duration-300">
              ...
              <p className="text-gray-400">Python script used for web scraping</p>
              <a
